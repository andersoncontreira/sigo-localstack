...
from chalicelib.http.request_control import Pagination, Order
...
class ApiRequest:
    ...
    def parse_request(self, app):
        ...
        :return:
        """
        request_parser = ChaliceRequestParser()
        parsed_request = request_parser.parse(app.current_request)
        ...
        self._request = app.current_request
